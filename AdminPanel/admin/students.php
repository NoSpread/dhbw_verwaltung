...
$db = getDbInstance();
$select = array('id', 'f_name', 'l_name', 'gender', 'matr_nbr','created_at','updated_at');
        ...
        <tbody>
            <?php foreach ($students as $row) : ?>
                <tr>
	                ...
	                <td><?php echo htmlspecialchars($row['matr_nbr']) ?> </td>
	                <td>
					<a href="edit_student.php?student_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="students.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
